...
##
#
# AbeWorkflowConfigurator 
#
class AbeWorkflowConfigurator(WorkflowConfigurator):
    def __init__(self, runid, logger, verbosity):
        ...
        self.runid = runid
        self.logger = logger
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:__init__")
    ...
    def configure(self, policy, configurationDict, provenanceDict, repository):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:configure")
    ...
    def createLaunchCommand(self):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:createLaunchCommand")
        ...
        launchArgs = "%s %s -L %s -S %s" % \
             (self.workflow+".paf", self.runid, self.verbosity, self.script)  

        # Write Condor file 
        # print "launchWorkflow: Write Condor job file here"
        condorJobfile =  os.path.join("/tmp",self.workflow+"_"+self.runid+".condor")
        ...
        clist.append("output="+self.workflow+"Condor.out\n")
        clist.append("error="+self.workflow+"Condor.err\n")
        clist.append("log="+self.workflow+"Condor.log\n")
    ...
    def createNodeList(self):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:createNodeList")
    ...
    def prepPlatform(self):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:prepPlatform")
        self.createDirs()

    def copyToRemote(self, localName, remoteName):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:copyToRemote")
    ...
    def deploySetup(self):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:deploySetup")
    ...
    def writeLaunchScript(self):
        ...
        launcher.write("launchWorkflowAbe.sh $@\n")
        launcher.close()
        # make it executable
    ...
    #
    def createDirs(self):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:createDirs")
    ...
    def setupDatabase(self):
        self.logger.log(Log.DEBUG, "AbeWorkflowConfigurator:setupDatabase")
