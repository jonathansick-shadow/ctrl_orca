...
class CondorWorkflowConfigurator(WorkflowConfigurator):
    ...
    def _configureSpecialized(self, wfPolicy):
        ...
        cmd = ["echo", "test"]
        workflowLauncher = CondorWorkflowLauncher(cmd, self.prodPolicy, self.wfPolicy, self.logger)
    ...
    def copyToRemote(self, localName, remoteName):
        self.logger.log(Log.DEBUG, "CondorWorkflowConfigurator:copyToRemote")
    ...
    def remoteChmodX(self, remoteName):
        self.logger.log(Log.DEBUG, "CondorWorkflowConfigurator:remoteChmodX")
